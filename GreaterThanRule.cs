...
{
    public class GreaterThanRule : AlertRuleBase
    {
        public string ComparisonValue { get; set; }

        public GreaterThanRule(string propertyName, string comparisonValue, Color alertColor, string description, int severity)
